...
<body>
    ...
    <div id="login" class="fixed flex h-full w-full content-center items-center justify-center bg-[#E7F1F1] bg-opacity-50 p-20 pb-0 pt-0 backdrop-blur-md">
        ...
        <div class="w-full flex flex-col justify-center items-center mb-0 mt-[-10px]">
    <img class="h-60 w-auto" src="/src/public/img/logoLogin.png" alt="Logo da CadCli" />
    <h2 class="mt-[-10px] text-center text-3xl font-bold tracking-tight text-[rgb(10,10,10)]">Entre na sua conta</h2>
</div>
          ...
          <?php if (isset($error)): ?>
            ...
            <form class="space-y-6" action="index.php?action=login" method="POST">
              <div>
                <div class="mt-2 flex">
                  <div class="z-10 mr-[-8px] flex items-center justify-center rounded-[6px] border-r-0 bg-white px-3 py-1.7 text-base text-[rgba(10,10,10,0.96)] outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400">
            ...
            <div class="mt-2 flex w-full items-center justify-between gap-16 p-4 px-0">
              <div class="flex items-center gap-2">
                <div class="flex h-5 items-center">
                  <input id="helper-checkbox" aria-describedby="helper-checkbox-text" type="checkbox" value="" class="h-4 w-4 rounded border-gray-400 bg-white text-black" />
                </div>
                <p class="text-center text-sm/6 text-black font-semibold">Lembrar-me</p>
              </div>
              <a href="#" class="text-sm/6 font-semibold text-gray-500 transition-colors hover:text-indigo-800">Esqueci minha senha</a>
            </div>
          </div>
        </div>
